...
Вертикальный шардинг - храним на каждом сервере свою таблицу. Т.е. условно, сервер server_user отвечает за авторизацию, server_books - за каталог, server_stores - за продажи. 

![alt text](image.png)

Каждый сервер работает по схеме master-slave в асинхронном режиме.

Горизонтальный шардинг - также имеем 3 сервера, но в этом случае данные по трем таблицам разбиваем на 3 ноды. 
